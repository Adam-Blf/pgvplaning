...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Create team with sector and leave days for both employee types (code is auto-generated by trigger)
    ...
    // Add user as leader with default employee leave days (can be changed later in admin)
